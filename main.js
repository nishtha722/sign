...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/15KV-kY-o/model.json', modelLoaded);
...
function got_Result(error, results) {
    if(error){
        ...
        {
            document.getElementById("update_emoji2").innerHTML = '&#128072';
        }
